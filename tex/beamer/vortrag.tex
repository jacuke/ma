...
\begin{frame}
  ...
  Beispiele:
    \begin{itemize}
        \item Umsteiger-Einträge ausnehmen, wenn die Kodes gleich und in beide Richtungen automatisch überleitbar sind
		\item Entfernen von nicht-entständigen Kodes
		\item Konvertierung der Zeichenkodierung
...
\begin{frame}
    ...
    \begin{itemize}
		...
		Füllen eines Modals mit dem Ergebnis der horizontalen Suche
    \end{itemize}
\end{frame}
