...
\begin{frame}
    ...
    (Screenshots im Anhang zur Sicherheit)
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        \item Daten: Per FHIR ConcepMap über alle Versionen
        \item Anzeige: Per API/Frameworks über andere Seiten
    \end{itemize}
\end{frame}
